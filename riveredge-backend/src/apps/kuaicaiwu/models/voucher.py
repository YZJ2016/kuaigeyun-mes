...
class Voucher(BaseModel):
    ...
    total_debit = fields.DecimalField(max_digits=16, decimal_places=4, default=0, description="借方合计")
    total_credit = fields.DecimalField(max_digits=16, decimal_places=4, default=0, description="贷方合计")
