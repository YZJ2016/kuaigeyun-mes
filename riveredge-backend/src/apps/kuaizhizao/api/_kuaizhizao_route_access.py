...
_PRODUCTIONS_PATH_MODULES: tuple[tuple[str, str], ...] = (
    ...
    ("/outsource-work-orders", "outsource-work-order"),
    ("/outsource-material-issues", "outsource-issue"),
    ("/outsource-material-returns", "outsource-material-return"),
    ("/outsource-product-returns", "outsource-product-return"),
    ("/outsource-settlements", "outsource-settlement"),
