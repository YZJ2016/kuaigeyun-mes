...
MOVEMENT_FG_RECEIPT_WITHDRAW = "fg_receipt_withdraw"
MOVEMENT_SEMI_FG_RECEIPT_WITHDRAW = "semi_fg_receipt_withdraw"
MOVEMENT_PURCHASE_RECEIPT_WITHDRAW = "purchase_receipt_withdraw"
MOVEMENT_OTHER_INBOUND_WITHDRAW = "other_inbound_withdraw"
