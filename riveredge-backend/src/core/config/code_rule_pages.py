...
PAGE_CODE_TO_FIXED_TEXT_PRESET: Dict[str, str] = {
    ...
    "kuaizhizao-equipment-spot-check": "DJ",  # 设备点检
    "kuaizhizao-equipment-route-patrol": "LX",  # 路线巡检
    "kuaizhizao-equipment-fault": "GZ",  # 设备故障报修
    "kuaizhizao-equipment-repair": "WX",  # 设备维修台账
    "kuaizhizao-maintenance-plan": "BYJH",  # 维护保养计划
    "kuaizhizao-maintenance-execution": "BYZX",  # 保养执行记录
    "kuaizhizao-equipment-scrap": "BFSQ",  # 设备报废申请
    "kuaizhizao-equipment-transfer": "SBDB",  # 设备调拨申请
    "kuaizhizao-mold-trial": "SM",  # 模具试模
    "kuaizhizao-mold-borrow": "MJLY",  # 模具领用
    "kuaizhizao-mold-return": "MJGH",  # 模具归还
    "kuaizhizao-mold-maintenance": "MJBY",  # 模具保养
    "kuaizhizao-mold-repair": "MJWX",  # 模具维修
    "kuaizhizao-mold-scrap": "MJBFSQ",  # 模具报废申请
    "kuaizhizao-tool-borrow": "GZLY",  # 工装领用
    "kuaizhizao-tool-return": "GZGH",  # 工装归还
    "kuaizhizao-tool-maintenance": "GZBY",  # 工装保养
    "kuaizhizao-tool-repair": "GZWX",  # 工装维修
    "kuaizhizao-tool-calibration": "GZJZ",  # 工装校准
    "kuaizhizao-tool-scrap": "GZBFSQ",  # 工装报废申请
...
CODE_RULE_PAGES: List[CodeRulePageConfig] = [
    ...
    {
        "page_code": "kuaizhizao-equipment-spot-check",
        "page_name": "设备点检",
        "page_path": "/apps/kuaizhizao/equipment-management/spot-checks",
        "code_field": "document_no",
        "code_field_label": "点检单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "equipment_spot_check_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-equipment-route-patrol",
        "page_name": "路线巡检",
        "page_path": "/apps/kuaizhizao/equipment-management/route-patrols",
        "code_field": "document_no",
        "code_field_label": "巡检单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "equipment_route_patrol_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-equipment-fault",
        "page_name": "报修维修",
        "page_path": "/apps/kuaizhizao/equipment-management/equipment-faults",
        "code_field": "fault_no",
        "code_field_label": "故障单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-equipment-repair",
        "page_name": "维修台账",
        "page_path": "/apps/kuaizhizao/equipment-management/equipment-repairs",
        "code_field": "repair_no",
        "code_field_label": "维修单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-maintenance-plan",
        "page_name": "维护保养计划",
        "page_path": "/apps/kuaizhizao/equipment-management/maintenance-plans",
        "code_field": "plan_no",
        "code_field_label": "计划编号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-maintenance-execution",
        "page_name": "保养执行记录",
        "page_path": "/apps/kuaizhizao/equipment-management/maintenance-executions",
        "code_field": "execution_no",
        "code_field_label": "执行编号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-equipment-scrap",
        "page_name": "设备报废",
        "page_path": "/apps/kuaizhizao/equipment-management/equipment-scrap",
        "code_field": "application_no",
        "code_field_label": "报废申请单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "equipment_scrap_application_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-equipment-transfer",
        "page_name": "设备调拨",
        "page_path": "/apps/kuaizhizao/equipment-management/equipment-transfers",
        "code_field": "application_no",
        "code_field_label": "调拨申请单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "equipment_transfer_application_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-mold-trial",
        "page_name": "模具试模",
        "page_path": "/apps/kuaizhizao/equipment-management/mold-trials",
        "code_field": "document_no",
        "code_field_label": "试模单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "mold_trial_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-mold-borrow",
        "page_name": "模具领用",
        "page_path": "/apps/kuaizhizao/equipment-management/mold-borrows",
        "code_field": "document_no",
        "code_field_label": "领用单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "mold_borrow_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-mold-return",
        "page_name": "模具归还",
        "page_path": "/apps/kuaizhizao/equipment-management/mold-returns",
        "code_field": "document_no",
        "code_field_label": "归还单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "mold_return_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-mold-maintenance",
        "page_name": "模具保养",
        "page_path": "/apps/kuaizhizao/equipment-management/mold-maintenances",
        "code_field": "document_no",
        "code_field_label": "保养单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "mold_maintenance_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-mold-repair",
        "page_name": "模具维修",
        "page_path": "/apps/kuaizhizao/equipment-management/mold-repairs",
        "code_field": "document_no",
        "code_field_label": "维修单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "mold_repair_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-mold-scrap",
        "page_name": "模具报废",
        "page_path": "/apps/kuaizhizao/equipment-management/mold-scrap-applications",
        "code_field": "application_no",
        "code_field_label": "报废申请单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "mold_scrap_application_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-tool-borrow",
        "page_name": "工装领用",
        "page_path": "/apps/kuaizhizao/equipment-management/tool-borrows",
        "code_field": "document_no",
        "code_field_label": "领用单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "tool_borrow_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-tool-return",
        "page_name": "工装归还",
        "page_path": "/apps/kuaizhizao/equipment-management/tool-returns",
        "code_field": "document_no",
        "code_field_label": "归还单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "tool_return_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-tool-maintenance",
        "page_name": "工装保养",
        "page_path": "/apps/kuaizhizao/equipment-management/tool-maintenances",
        "code_field": "document_no",
        "code_field_label": "保养单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "tool_maintenance_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-tool-repair",
        "page_name": "工装维修",
        "page_path": "/apps/kuaizhizao/equipment-management/tool-repairs",
        "code_field": "document_no",
        "code_field_label": "维修单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "tool_repair_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-tool-calibration",
        "page_name": "工装校准",
        "page_path": "/apps/kuaizhizao/equipment-management/tool-calibrations",
        "code_field": "document_no",
        "code_field_label": "校准单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "tool_calibration_code",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-tool-scrap",
        "page_name": "工装报废",
        "page_path": "/apps/kuaizhizao/equipment-management/tool-scrap-applications",
        "code_field": "application_no",
        "code_field_label": "报废申请单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "tool_scrap_application_code",
        "allow_manual_edit": False,
    },
    # 快格轻制造 - 生产执行（补充）
    {
