...
DOCUMENT_TYPE_LABEL_ZH: Dict[str, str] = {
    ...
    "reporting_timeline": "报工（汇总）",
    "production_plan": "生产计划",
    "outsource_order": "工序委外单",
    "outsource_work_order": "工单委外",
    "outsource_material_receipt": "委外收货单",
    "outsource_receipt": "委外收货单",
    "outsource_material_issue": "委外发料单",
    "outsource_material_return": "委外退料单",
    "outsource_product_return": "委外退货单",
