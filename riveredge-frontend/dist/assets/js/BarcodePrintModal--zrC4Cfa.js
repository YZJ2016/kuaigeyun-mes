import{r as n,af as l,j as r,M as z,D as w,T as j,aR as v,at as k,Z as T,aA as S,V as h,aS as P}from"./vendor-CnMXFG2q.js";import{aq as _,a5 as O}from"./main-BIvZiXh7.js";import{b as R}from"./clientRelease-yWNYQJ29.js";import"./index.es-Bjqzx9Af.js";import"./sessionCurrentUser-DAt95z7A.js";import"./globalStore-Dw0j7n4w.js";import"./restoredUser-BZaTkeec.js";import"./tokenRefresh-CaGDTqtm.js";import"./building-2-C1LMzvHJ.js";import"./index-D_AQTlKV.js";import"./vendor-libredwg-Vf_Z3ZV8.js";import"./vendor-three-BPXNOO5B.js";import"./clearSessionQueries-Db_KN_8V.js";const{Title:L}=j,W=({visible:d,onCancel:p,workOrderId:m,operationId:x,level:t="operation"})=>{const{t:a}=R(),[g,i]=n.useState(!1),[c,b]=n.useState([]),[o,u]=n.useState(null);n.useEffect(()=>{d&&f()},[d,t]);const f=async()=>{try{i(!0);const s=await _({type:t==="work_order"?"work_order":"operation"});b(s||[]),s&&s.length>0&&u(s[0].uuid)}catch(e){console.error("Failed to load print templates",e),l.error(a("app.kuaizhizao.workOrder.msgLoadPrintTemplateFailed"))}finally{i(!1)}},y=async()=>{if(!o){l.warning(a("app.kuaizhizao.workOrder.msgSelectPrintTemplatePlaceholder"));return}try{i(!0);const e=t==="work_order"?`/api/v1/apps/kuaizhizao/work-orders/${m}/print?template_uuid=${o}`:`/api/v1/apps/kuaizhizao/work-orders/${m}/operations/${x}/print?template_uuid=${o}`;window.open(e,"_blank"),l.success(a("app.kuaizhizao.workOrder.msgPrintRequestSent")),p()}catch(e){console.error("Print failed",e),l.error(a("app.kuaizhizao.workOrder.msgPrintFailed"))}finally{i(!1)}};return r.jsxs(z,{title:r.jsxs("span",{style:{color:"#fff",fontSize:20},children:["条码打印 - ",t==="work_order"?"工单级":"工序级"]}),open:d,onCancel:p,footer:null,width:O.SMALL_WIDTH,centered:!0,rootClassName:"kiosk-modal-terminal-bg",styles:{mask:{backgroundColor:"rgba(0, 0, 0, 0.5)"},body:{padding:"24px",background:"#1a1a1a"}},children:[r.jsx("style",{children:`
