import{r as n,af as l,j as r,M as z,D as w,T as j,aR as v,at as k,Z as T,aA as S,V as h,aS as P}from"./vendor-CET6_jnT.js";import{ae as R,R as _}from"./main-Doc9a6V4.js";import{b as O}from"./clientRelease-BvoQSrlt.js";import"./index.es-VjWI4C0C.js";import"./sessionCurrentUser-BFM4uS9W.js";import"./globalStore-CCJ4KO0d.js";import"./restoredUser-CdRbDnCC.js";import"./tokenRefresh-CXAWcWvy.js";import"./building-2-F-UCRUvO.js";import"./index-CjqLF8x4.js";import"./vendor-libredwg-DDhc_lPN.js";import"./vendor-three-BPXNOO5B.js";import"./clearSessionQueries-Db_KN_8V.js";const{Title:L}=j,q=({visible:d,onCancel:p,workOrderId:m,operationId:x,level:t="operation"})=>{const{t:a}=O(),[g,i]=n.useState(!1),[c,b]=n.useState([]),[o,u]=n.useState(null);n.useEffect(()=>{d&&f()},[d,t]);const f=async()=>{try{i(!0);const s=await R({type:t==="work_order"?"work_order":"operation"});b(s||[]),s&&s.length>0&&u(s[0].uuid)}catch(e){console.error("Failed to load print templates",e),l.error(a("app.kuaizhizao.workOrder.msgLoadPrintTemplateFailed"))}finally{i(!1)}},y=async()=>{if(!o){l.warning(a("app.kuaizhizao.workOrder.msgSelectPrintTemplatePlaceholder"));return}try{i(!0);const e=t==="work_order"?`/api/v1/apps/kuaizhizao/work-orders/${m}/print?template_uuid=${o}`:`/api/v1/apps/kuaizhizao/work-orders/${m}/operations/${x}/print?template_uuid=${o}`;window.open(e,"_blank"),l.success(a("app.kuaizhizao.workOrder.msgPrintRequestSent")),p()}catch(e){console.error("Print failed",e),l.error(a("app.kuaizhizao.workOrder.msgPrintFailed"))}finally{i(!1)}};return r.jsxs(z,{title:r.jsxs("span",{style:{color:"#fff",fontSize:20},children:["条码打印 - ",t==="work_order"?"工单级":"工序级"]}),open:d,onCancel:p,footer:null,width:_.SMALL_WIDTH,centered:!0,rootClassName:"kiosk-modal-terminal-bg",styles:{mask:{backgroundColor:"rgba(0, 0, 0, 0.5)"},body:{padding:"24px",background:"#1a1a1a"}},children:[r.jsx("style",{children:`
