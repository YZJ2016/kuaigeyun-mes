import{C as K,r as n,j as t,D as M,a7 as O,N as w,Z as H,aw as R,O as _,aX as L,al as V,ak as G,aC as W,ce as X}from"./vendor-kCai97Dq.js";import{T as Y}from"./PremiumTerminalTemplate-TCq2zhH2.js";import{f5 as Z}from"./main-ByTFquGh.js";import{U as v}from"./clientRelease-BNTrN0TK.js";import"./design-B_8Sx7jg.js";import"./touch-CzJ4Jti_.js";import"./index.es-DysyXJn3.js";import"./sessionCurrentUser-wjh1Ivn6.js";import"./globalStore-D-DguYKo.js";import"./restoredUser-C8fEewFj.js";import"./tokenRefresh-Df6dLUc9.js";import"./building-2-C5vk7WM9.js";import"./index-ClzvMPcu.js";import"./vendor-libredwg-BunBhOAm.js";import"./vendor-three-BPXNOO5B.js";import"./clearSessionQueries-Db_KN_8V.js";const{Search:q}=_,fe=()=>{const{message:a}=K.useApp(),C=Z(),[I,j]=n.useState(!1),[i,u]=n.useState(""),[f,x]=n.useState(""),[b,E]=n.useState(""),[o,k]=n.useState([]),[c,m]=n.useState(-1),y=n.useRef(null),S=n.useRef(null);n.useEffect(()=>{const e=new URLSearchParams(window.location.search),r=e.get("code"),s=e.get("programCode"),d=e.get("programUrl"),h=e.get("name")||e.get("programName");r?(u(r),x(h||"加工程序")):s?(u(s),x(h||"加工程序")):d?U(d):a.warning("请提供程序代码或程序URL")},[]);const U=async e=>{j(!0);try{const r=await fetch(e);if(!r.ok)throw new Error("加载程序失败");const s=await r.text();u(s),x("加工程序")}catch(r){a.error(r.message||"加载程序失败")}finally{j(!1)}},T=n.useCallback(e=>{if(!e||!i){k([]),m(-1);return}const r=i.split(`
