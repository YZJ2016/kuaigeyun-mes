...
export const KUAIZHIZAO_DOCUMENT_ACTION_REGISTRY: Record<KuaizhizaoDocumentActionKey, KuaizhizaoDocumentActionDefinition> = {
  ...
  'purchase_order.pull_from_demand_computation': {
    key: 'purchase_order.pull_from_demand_computation',
    module: 'kuaizhizao',
    kind: 'pull_create',
  ...
  'sales_return.pull_from_sales_delivery': {
    key: 'sales_return.pull_from_sales_delivery',
    module: 'kuaizhizao',
    kind: 'pull_create',
    labelKey: documentActionI18n('sales_return.pull_from_sales_delivery', 'label'),
    sourceLabelKey: documentActionI18n('sales_return.pull_from_sales_delivery', 'source'),
    targetLabelKey: documentActionI18n('sales_return.pull_from_sales_delivery', 'target'),
  },
  'after_sales_ticket.pull_from_sales_order': {
  ...
  'inbound.pull_from_finished_goods_inspection': {
    key: 'inbound.pull_from_finished_goods_inspection',
    module: 'kuaizhizao',
    kind: 'pull_create',
