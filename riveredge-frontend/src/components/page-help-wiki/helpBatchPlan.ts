...
export const HELP_BATCH3_KZ_DOCUMENTS: HelpBatchPlanItem[] = [
  ...
  { id: 'doc.outsource-work-order', title: '外协工单', profile: 'richDocument', contentKey: 'outsource-work-order', pagePath: 'apps/kuaizhizao/pages/outsource-management/outsource-work-orders/index.tsx', needsHelpView: true },
  { id: 'doc.outsource-order', title: '外协订单', profile: 'richDocument', contentKey: 'outsource-order', pagePath: 'apps/kuaizhizao/pages/outsource-management/outsource-orders/index.tsx', needsHelpView: true },
