...
export const CODE_RULE_PAGES: CodeRulePageConfig[] = [
  ...
  {
    pageCode: 'kuaizhizao-demand-plan',
    pageName: '需求计划',
    pagePath: '/apps/kuaizhizao/plan-management/demand-management',
    codeField: 'demand_code',
    codeFieldLabel: '需求计划编码',
    module: '快格轻制造',
    moduleIcon: 'tool',
    autoGenerate: true,
    ruleCode: 'DEMAND_PLAN_CODE',
    allowManualEdit: true,
  },
  {
    pageCode: 'kuaizhizao-demand-computation',
    pageName: '需求计算',
    pagePath: '/apps/kuaizhizao/plan-management/demand-computation',
    codeField: 'computation_code',
    codeFieldLabel: '需求计算编码',
    module: '快格轻制造',
    moduleIcon: 'tool',
    autoGenerate: true,
    ruleCode: 'DEMAND_COMPUTATION_CODE',
    allowManualEdit: true,
  },
  {
  ...
  {
    pageCode: 'kuaizhizao-delivery-project',
    pageName: '交付项目',
    pagePath: '/apps/kuaizhizao/delivery-project/projects',
    codeField: 'project_code',
    codeFieldLabel: '项目编号',
    module: '快制造',
    moduleIcon: 'production',
  ...
  {
    pageCode: 'kuaiplm-rd-requirement',
    pageName: '研发需求',
    pagePath: '/apps/kuaiplm/phase2/requirements',
    codeField: 'requirement_code',
    codeFieldLabel: '需求编码',
    module: '快研发',
    moduleIcon: 'experiment',
    autoGenerate: true,
    ruleCode: 'RD_REQUIREMENT_CODE',
    allowManualEdit: true,
  },
  {
    pageCode: 'kuaiplm-design-review',
    pageName: '设计评审',
    pagePath: '/apps/kuaiplm/phase2/design-reviews',
    codeField: 'review_code',
    codeFieldLabel: '评审编码',
    module: '快研发',
    moduleIcon: 'experiment',
    autoGenerate: true,
    ruleCode: 'RD_DESIGN_REVIEW_CODE',
    allowManualEdit: true,
  },
  {
    pageCode: 'kuaiplm-fmea',
    pageName: '失效分析 (FMEA)',
    pagePath: '/apps/kuaiplm/phase2/fmea',
    codeField: 'fmea_code',
    codeFieldLabel: 'FMEA编码',
    module: '快研发',
    moduleIcon: 'experiment',
    autoGenerate: true,
    ruleCode: 'RD_FMEA_CODE',
    allowManualEdit: true,
  },
];
