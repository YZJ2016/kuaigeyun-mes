...
export const PRINT_TEMPLATE_SCHEMAS: Record<string, TemplateSchema> = {
  ...
  purchase_order: {
    ...
    fields: [
      ...
      { key: 'purchaser_name', label: '采购员', type: 'string' },
      { key: 'buyer_name', label: '归属采购员', type: 'string' },
      { key: 'order_date', label: '订单日期', type: 'date' },
      { key: 'required_date', label: '要求到货日期', type: 'date' },
  ...
  purchase_requisition: {
    ...
    name: '采购申请',
    fields: [
      { key: 'code', label: '申请编号', type: 'string' },
      { key: 'requisition_name', label: '申请名称', type: 'string' },
      { key: 'applicant_name', label: '申请人', type: 'string' },
      { key: 'requisition_date', label: '申请日期', type: 'date' },
      { key: 'required_date', label: '要求到货日期', type: 'date' },
      { key: 'status', label: '状态', type: 'string' },
      { key: 'source_type', label: '来源类型', type: 'string' },
      { key: 'source_code', label: '来源单号', type: 'string' },
      { key: 'reviewer_name', label: '审核人', type: 'string' },
      { key: 'review_time', label: '审核时间', type: 'date' },
      { key: 'notes', label: '备注', type: 'string' },
      { key: 'created_at', label: '创建时间', type: 'date' },
      {
        key: 'items',
        ...
        children: [
          ...
          { key: 'items.0.material_spec', label: '规格（第1项）', type: 'string' },
          { key: 'items.0.material_unit', label: '单位（第1项）', type: 'string' },
          { key: 'items.0.quantity', label: '申请数量（第1项）', type: 'number' },
          { key: 'items.0.suggested_unit_price', label: '建议单价（第1项）', type: 'number' },
          { key: 'items.0.required_date', label: '行到货日（第1项）', type: 'date' },
          { key: 'items.0.supplier_name', label: '建议供应商（第1项）', type: 'string' },
          { key: 'items.0.notes', label: '行备注（第1项）', type: 'string' },
        ],
      },
    ],
  ...
  sales_review: {
    ...
    name: '订单评审',
    fields: [
      { key: 'code', label: '评审单号', type: 'string' },
      { key: 'review_code', label: '评审单号', type: 'string' },
      { key: 'customer_name', label: '客户名称', type: 'string' },
      { key: 'customer_code', label: '客户编码', type: 'string' },
      { key: 'customer_contact', label: '联系人', type: 'string' },
      { key: 'customer_phone', label: '联系电话', type: 'string' },
      { key: 'project_name', label: '项目名称', type: 'string' },
      { key: 'review_date', label: '评审日期', type: 'date' },
      { key: 'delivery_date', label: '交付日期', type: 'date' },
      { key: 'urgency', label: '紧急程度', type: 'string' },
      { key: 'risk_level', label: '风险等级', type: 'string' },
      { key: 'status', label: '状态', type: 'string' },
      { key: 'review_round', label: '评审轮次', type: 'number' },
      { key: 'salesman_name', label: '业务员', type: 'string' },
      { key: 'quotation_code', label: '报价单号', type: 'string' },
      { key: 'sales_order_code', label: '销售订单号', type: 'string' },
      { key: 'total_quantity', label: '总数量', type: 'number' },
      { key: 'total_amount', label: '总金额', type: 'number' },
      { key: 'final_conclusion', label: '最终结论', type: 'string' },
      { key: 'remarks', label: '备注', type: 'string' },
      { key: 'created_at', label: '创建时间', type: 'date' },
      {
        key: 'items',
        ...
        type: 'array',
        children: [
          { key: 'items.0.line_no', label: '行号（第1项）', type: 'number' },
          { key: 'items.0.material_code', label: '物料编号（第1项）', type: 'string' },
          { key: 'items.0.material_name', label: '物料名称（第1项）', type: 'string' },
          { key: 'items.0.material_spec', label: '规格（第1项）', type: 'string' },
          { key: 'items.0.material_unit', label: '单位（第1项）', type: 'string' },
          { key: 'items.0.quantity', label: '数量（第1项）', type: 'number' },
          { key: 'items.0.unit_price', label: '单价（第1项）', type: 'number' },
          { key: 'items.0.amount', label: '金额（第1项）', type: 'number' },
          { key: 'items.0.notes', label: '行备注（第1项）', type: 'string' },
        ],
      },
    ],
    ...
    fields: [
      ...
      { key: 'print_time', label: '打印时间', type: 'date' },
      {
        ...
        children: [
          ...
          { key: 'items.0.material_spec', label: '规格（第1项）', type: 'string' },
          { key: 'items.0.material_unit', label: '单位（第1项）', type: 'string' },
          { key: 'items.0.contract_quantity', label: '合同数量（第1项）', type: 'number' },
          { key: 'items.0.quote_quantity', label: '数量（第1项）', type: 'number' },
          { key: 'items.0.released_quantity', label: '已释放数量（第1项）', type: 'number' },
          { key: 'items.0.tax_rate', label: '税率（第1项）', type: 'number' },
          { key: 'items.0.unit_price', label: '单价（第1项）', type: 'number' },
          { key: 'items.0.total_amount', label: '金额（第1项）', type: 'number' },
          { key: 'items.0.delivery_date', label: '行交货日（第1项）', type: 'date' },
  ...
  eight_d_report: {
    ...
    name: '8D 质量报告',
    fields: [
      { key: 'report_code', label: '报告编码', type: 'string' },
      { key: 'title', label: '标题', type: 'string' },
      { key: 'status', label: '当前阶段', type: 'string' },
      { key: 'severity', label: '严重度', type: 'string' },
      { key: 'owner_name', label: '负责人', type: 'string' },
      { key: 'due_date', label: '计划完成', type: 'date' },
      { key: 'verification_result', label: '验证结果', type: 'string' },
      { key: 'd0_prepare', label: 'D0 准备响应', type: 'string' },
      { key: 'd1_team', label: 'D1 组建团队', type: 'string' },
      { key: 'd2_problem', label: 'D2 问题描述', type: 'string' },
      { key: 'd3_containment', label: 'D3 临时遏制', type: 'string' },
      { key: 'd4_root_cause', label: 'D4 根因分析', type: 'string' },
      { key: 'd5_corrective_action', label: 'D5 纠正措施', type: 'string' },
      { key: 'd6_implement_result', label: 'D6 实施验证', type: 'string' },
      { key: 'd7_prevent_recurrence', label: 'D7 防再发', type: 'string' },
      { key: 'd8_team_congratulation', label: 'D8 团队总结', type: 'string' },
      { key: 'remarks', label: '备注', type: 'string' },
      { key: 'created_by_name', label: '创建人', type: 'string' },
      { key: 'created_at', label: '创建时间', type: 'date' },
      { key: 'closed_at', label: '关闭时间', type: 'date' },
      { key: 'print_time', label: '打印时间', type: 'date' },
    ],
  },
  equipment_card: {
  ...
  mold_card: {
    ...
    fields: [
      ...
      { key: 'item.model', label: '型号', type: 'string' },
      { key: 'item.type', label: '类型', type: 'string' },
      { key: 'item.affiliation', label: '位置', type: 'string' },
      { key: 'item.purchase_date', label: '购买', type: 'date' },
      { key: 'item.installation_date', label: '启用', type: 'date' },
      { key: 'item.qrcode_image', label: '二维码图片', type: 'image' },
      {
        ...
        children: [
          ...
          { key: 'items.0.model', label: '型号', type: 'string' },
          { key: 'items.0.type', label: '类型', type: 'string' },
          { key: 'items.0.affiliation', label: '位置', type: 'string' },
          { key: 'items.0.purchase_date', label: '购买', type: 'date' },
          { key: 'items.0.installation_date', label: '启用', type: 'date' },
          { key: 'items.0.qrcode_image', label: '二维码', type: 'image' },
        ],
...
export const DOCUMENT_TYPE_TO_CODE: Record<string, string> = {
  ...
  eight_d_report: 'EIGHT_D_REPORT_PRINT',
  ...
  purchase_requisition: [
    {
      ...
      columns: [
        ...
        { key: 'suggested_unit_price', label: '建议单价' },
        { key: 'required_date', label: '行到货日' },
  ...
  sales_contract: [
    {
      ...
      columns: [
        ...
        { key: 'material_spec', label: '规格' },
        { key: 'material_unit', label: '单位' },
        { key: 'contract_quantity', label: '合同数量' },
        { key: 'released_quantity', label: '已释放数量' },
        { key: 'unit_price', label: '单价' },
        { key: 'tax_rate', label: '税率' },
        { key: 'total_amount', label: '金额' },
        { key: 'delivery_date', label: '行交货日' },
