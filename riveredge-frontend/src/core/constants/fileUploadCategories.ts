...
export const DOCUMENT_ATTACHMENT_MENU_PATHS: Record<string, string> = {
  ...
  outsource_work_order_attachments: '/apps/kuaizhizao/outsource-management/outsource-work-orders',
  outsource_order_attachments: '/apps/kuaizhizao/outsource-management/outsource-orders',
  ...
  mold_usage_attachments: '/apps/kuaizhizao/equipment-management/mold-borrows',
  mold_calibration_attachments: '/apps/kuaizhizao/equipment-management/mold-calibrations',
  tool_usage_attachments: '/apps/kuaizhizao/equipment-management/tool-borrows',
  ...
  delivery_node_task_attachments: '/apps/kuaizhizao/delivery-project/projects',
