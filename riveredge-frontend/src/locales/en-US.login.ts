...
export default {
  ...
  'pages.login.defaultPlatformName': 'StarTech',
  'pages.login.defaultDocTitle': 'StarTech - Multi-tenant Management',
  ...
  'pages.login.browserHintShort': 'For the best experience, we recommend using Chrome or Microsoft Edge.',
  ...
  'pages.login.wecomSelectTenant': 'Select an organization before signing in with WeCom',
  'pages.login.wecomSelectTenantModalTitle': 'Select organization',
  'pages.login.wecomSelectTenantModalHint': 'WeCom sign-in requires an organization. Search by name or domain (e.g. default), or use /login?tenant_id=1 in the URL.',
  'pages.login.wecomSelectTenantConfirm': 'Continue with WeCom',
  'pages.login.wecomTenantDomainPlaceholder': 'Search organization name or code',
  'pages.login.wecomNotConfigured': 'WeCom connector is not configured. Ask an admin to enable type=wecom in Application Connections',
  'pages.login.wecomRedirectFailed': 'WeCom login redirect failed. Please try again later',
  'pages.login.wecomVerifyFailed': 'WeCom login verification failed. Please retry',
  'pages.login.wecomLoginFailed': 'WeCom login failed. Please try again later',
  'pages.login.wecomPanelLoadFailed': 'Failed to load WeCom QR login. Please try again later',
  'pages.login.wecomQrLoginTitle': 'WeCom QR Login',
