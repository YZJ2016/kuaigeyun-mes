...
export default {
  ...
  'pages.login.noAccount': 'アカウントをお持ちでない場合',
  ...
  'pages.login.browserHintShort': '最高のエクスペリエンスを得るには、Chrome または Microsoft Edge のご利用をお勧めします。',
  ...
  'pages.login.wecomSelectTenant': 'WeCom でサインインする前に組織を選択してください',
  'pages.login.wecomSelectTenantModalTitle': '組織を選択',
  'pages.login.wecomSelectTenantModalHint': 'WeCom サインインには組織の指定が必要です。名称またはコード（例: default）で検索するか、URL に /login?tenant_id=1 を使用してください。',
  'pages.login.wecomSelectTenantConfirm': 'WeCom で続行',
  'pages.login.wecomTenantDomainPlaceholder': '組織名またはコードで検索',
  'pages.login.wecomNotConfigured': 'WeCom コネクタが未設定です。管理者に Application Connections で type=wecom を有効化してもらってください',
  'pages.login.wecomRedirectFailed': 'WeCom ログインのリダイレクトに失敗しました。後でもう一度試してください',
  'pages.login.wecomVerifyFailed': 'WeCom ログインの検証に失敗しました。再試行してください',
  'pages.login.wecomLoginFailed': 'WeCom ログインに失敗しました。後でもう一度試してください',
  'pages.login.wecomPanelLoadFailed': 'WeCom QR ログインを読み込めませんでした。後でもう一度試してください',
  'pages.login.wecomQrLoginTitle': 'WeCom QR ログイン',
  'pages.login.wecomQrLoginHint': 'WeCom で QR コードをスキャンしてログインを確認してください',
  'common.cancel': 'キャンセル',
