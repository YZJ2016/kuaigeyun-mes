 ...
 * 兼容 manifest/库表中的 Lucide PascalCase（如 LayoutDashboard → layoutDashboard / shield-check）。
 */
export function resolveMenuIconComponent(iconKey: string): React.ComponentType<any> | null {
  ...
  if (/^[A-Z]/.test(trimmed) && !trimmed.includes('-') && !trimmed.includes('_')) {
    ...
    if (camel !== trimmed) candidates.push(camel);
    const kebab = trimmed.replace(/([a-z\d])([A-Z])/g, '$1-$2').toLowerCase();
    if (!candidates.includes(kebab)) candidates.push(kebab);
  }
  for (const key of candidates) {
    const hit = ManufacturingIcons[key as keyof typeof ManufacturingIcons];
    if (hit) return hit;
  }
  return null;
}
...
export const ManufacturingIcons = {
  ...
  'file-text': getLucideIcon('FileText'), // 历史库表/旧 manifest kebab 键，与 fileText 同图
  ...
  'line-chart': getLucideIcon('LineChart'),
  ...
  // 好力 GO manifest Lucide PascalCase → camelCase（侧栏/快捷入口解析）
  alertOctagon: getLucideIcon('AlertOctagon'),
  barChart3: getLucideIcon('BarChart3'),
  barChartBig: getLucideIcon('BarChartBig'),
  bellElectric: getLucideIcon('BellElectric'),
  bookMarked: getLucideIcon('BookMarked'),
  building2: getLucideIcon('Building2'),
  calendarClock: getLucideIcon('CalendarClock'),
  calendarDays: getLucideIcon('CalendarDays'),
  chartNoAxesCombined: getLucideIcon('ChartNoAxesCombined'),
  circleCheckBig: getLucideIcon('CircleCheckBig'),
  clipboardPenLine: getLucideIcon('ClipboardPenLine'),
  filePenLine: getLucideIcon('FilePenLine'),
  filePlus2: getLucideIcon('FilePlus2'),
  fileStack: getLucideIcon('FileStack'),
  flaskConical: getLucideIcon('FlaskConical'),
  hardDriveUpload: getLucideIcon('HardDriveUpload'),
  layers2: getLucideIcon('Layers2'),
  lineChart: getLucideIcon('LineChart'),
  listChecks: getLucideIcon('ListChecks'),
  messageSquareWarning: getLucideIcon('MessageSquareWarning'),
  notebookText: getLucideIcon('NotebookText'),
  packageMinus: getLucideIcon('PackageMinus'),
  packagePlus: getLucideIcon('PackagePlus'),
  pauseOctagon: getLucideIcon('PauseOctagon'),
  scrollText: getLucideIcon('ScrollText'),
  shapes: getLucideIcon('Shapes'),
  shieldCheck: getLucideIcon('ShieldCheck'),
  slidersHorizontal: getLucideIcon('SlidersHorizontal'),
  tv: getLucideIcon('Tv'),
  waypoints: getLucideIcon('Waypoints'),
} as const;
